...
export function Editor(props) {
    return <div>
        <div id="controlPanel">
            ...
            <Button onClick={Controller.upload} variant="outline-primary" id="uploadBtn">
        ...
        {props.fieldList.slice(0, props.fieldList.length - 1, 1).map(i =>
            <InputGroup className="mb-3" id="inputBox">
                <InputGroup.Prepend id="pre">
                    <InputGroup.Text ref={i[1]}><div class='preBox'>{i[1]}</div></InputGroup.Text>
                </InputGroup.Prepend>
        ...
        <Button block variant="outline-info"><svg class="bi bi-plus-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
